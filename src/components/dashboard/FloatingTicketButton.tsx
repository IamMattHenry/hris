              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-md text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#4B0B14]"
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-3 py-2 border border-gray-300 text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-[#4B0B14]"
