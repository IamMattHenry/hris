    ...
    <div className="min-h-screen p-4 md:p-8 font-poppins bg-[#fcfaf8]">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/3 xl:w-1/4 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-[#e8dcc8] p-6 flex flex-col items-center text-center">
            ...
            <div className="w-full border-t border-[#f5e6d3] pt-5 space-y-3 text-left text-sm">
          ...
          {/* Notifications Panel */}
          <div className="bg-white rounded-2xl shadow-sm border border-[#e8dcc8] flex-1 flex flex-col lg:sticky lg:top-8 max-h-[600px]">
            <div className="bg-[#281b0d] px-5 py-4 flex items-center justify-between rounded-t-2xl">
            ...
            <div className="p-4 flex flex-col overflow-y-auto custom-scrollbar flex-1">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-[#e8dcc8] overflow-hidden flex flex-col md:col-span-2">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-5 border border-[#e8dcc8] rounded-xl bg-white hover:bg-[#fdf9f3] hover:border-[#d4bb9b] transition-all duration-200 group cursor-default">
                  ...
                  <p className="text-sm text-gray-600">Keep an eye on the left panel for important announcements and shift changes.</p>
                </div>
