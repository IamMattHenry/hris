...
export default function PenaltyTable() {
  ...
  return (
    <div className="min-h-screen bg-[#fff7ec] p-8 space-y-6 text-[#3b2b1c] font-poppins">
                  ...
                  <tr key={item.id} className="border-b border-[#e2d5c3] hover:bg-[#fdf4e7] transition">
                    ...
                    <td className="py-4 px-4 text-right font-semibold">
                      ...
                      <span className="text-xs text-gray-500">
                        Remaining: ₱{Number(item.remaining_amount || 0).toLocaleString()}
                      </span>
                    </td>
      ...
      {/* FIXED PENALTY DETAIL MODAL */}
      {selectedPenaltyId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[92vh] flex flex-col overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between border-b border-[#e2d5c3] px-6 py-4 bg-[#faeddc] flex-shrink-0">
              <h2 className="text-xl font-semibold text-[#3b2b1c]">Penalty Details</h2>
              <button
                onClick={closeDetailModal}
                className="text-[#3b2b1c] hover:text-red-600 transition-colors p-1 rounded-full hover:bg-gray-100"
              >
                <X size={24} />
              </button>
            </div>
            ...
            {/* Scrollable Content */}
            <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-[#fff7ec] min-h-0">
              {detailLoading ? (
                  ...
                  <div className="bg-[#faeddc] rounded-xl border border-[#e2d5c3] p-6 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className={`ml-2 px-3 py-1 rounded-full text-xs font-medium ${
                        penaltyDetail.status.toLowerCase() === "settled"
                    ...
                    <div className="md:col-span-2">
                      ...
                      <p className="bg-white/70 p-4 rounded-lg border border-[#e2d5c3] whitespace-pre-wrap">
                          ...
                          return (
                            <div key={event.id} className="bg-white rounded-lg p-4 border border-[#e2d5c3]">
                              ...
                              <div className="text-gray-700 mt-1">
                                {event.from_status || "—"} → {event.to_status || "—"} by{" "}
            ...
            {/* Footer */}
            <div className="border-t border-[#e2d5c3] bg-[#faeddc] px-6 py-4 flex justify-end flex-shrink-0">
              <button
                onClick={closeDetailModal}
          ...
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-4">
              ...
              <input
                ...
                className="w-full rounded-md border border-[#d9c3a4] px-3 py-2 text-sm focus:outline-none focus:border-[#3b2b1c]"
            ...
            <div className="pt-4 flex justify-end gap-2">
              <button
                ...
                disabled={settling}
                className="px-4 py-2 text-sm rounded-md border border-[#d9c3a4] text-[#3b2b1c] hover:bg-gray-50"
              >
                Cancel
              </button>
              <button
                ...
                disabled={settling}
                className="px-4 py-2 text-sm rounded-md bg-[#3b2b1c] text-white disabled:opacity-50 hover:bg-[#4b1f16]"
              >
