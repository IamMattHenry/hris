...
const ActivityLogTab = () => {
    ...
    if (!isSuperAdmin) {
        return (
            <div className="min-h-screen bg-[#fff7ec] p-8 space-y-2 text-gray-800 font-poppins">
                <p className="text-center text-gray-500 ">You do not have permission to view this page.</p>
                <p className="text-center text-gray-500">Please contact your administrator.</p>
                <p className="text-center text-gray-500">Thank you.</p>
                <p className="text-center text-gray-500">You are being redirected to the dashboard.</p>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#fff7ec] p-8 space-y-6 text-gray-800 font-poppins">
            ...
            <div className="flex flex-wrap justify-between items-center mb-4">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-10 pr-4 py-2 rounded-lg border border-[#EAD7C4] focus:ring-2 focus:ring-[#B77E56] bg-white text-sm w-72"
                        value={searchTerm}
                ...
                <input
                    type="date"
                    className="px-4 py-2 rounded-lg border border-[#EAD7C4] bg-white text-gray-700 focus:ring-2 focus:ring-[#B77E56]"
                    value={date}
            ...
            <div className="border border-[#EAD7C4] rounded-xl shadow-sm overflow-hidden">
                ...
                <div
                    className={`${filteredActivities.length > 10
                ...
                >
                    {filteredActivities.length > 0 ? (
                        filteredActivities.map((activity, index) => (
                            <div
                                key={index}
                                className={`grid grid-cols-[120px_1.5fr_1.5fr_150px_120px_100px] items-center px-6 py-4 text-gray-800 border-b border-[#F3E5CF] ${index % 2 === 0 ? "bg-[#FFF9F1]" : "bg-[#FFF2E0]"
